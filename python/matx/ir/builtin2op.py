...
_register_python_builtin("math.exp2", "matx_math_exp2")
_register_python_builtin("math.exp10", "matx_math_exp10")
_register_python_builtin("math.erf", "math_erf")
_register_python_builtin("math.tanh", "math_tanh")
_register_python_builtin("math.sigmoid", "matx_math_sigmoid")
...
_register_python_builtin("math.rsqrt", "matx_math_rsqrt")
...
_register_python_builtin("math.nearbyint", "matx_math_nearbyint")
